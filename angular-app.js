...
function MainController($scope, $http) {
  ...
  $scope.baseClasses = baseClasses;
  $scope.magicClasses = magicClasses;
  $scope.settingClases = settingClases;
  $scope.raceClasses = raceClasses;
  $scope.undeadClasses = undeadClasses;

};

angular.module('dwclasses').directive(
  'ngWithModel',
  function() {
    return {
      restrict: 'A',
